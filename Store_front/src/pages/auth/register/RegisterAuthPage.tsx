...
import { RegisterAuthValidatorSchema } from "../../../store/auth/Validator";
import { IRegisterAuthProps, IRegisterAuthResult } from "../types";
...
const RegisterAuthPage: React.FC<IRegisterAuthProps> = ({ onNextStep }) => {
  ...
  const initialValues: IRegisterAuthResult = {
    password: "",
    confirmPassword: "",
  };

  const registerSubmitHandle = async (model: IRegisterAuthResult) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: RegisterAuthValidatorSchema,
  });
