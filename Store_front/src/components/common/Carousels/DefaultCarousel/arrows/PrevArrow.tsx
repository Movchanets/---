...
export const PrevArrow = (props: IArrowType) => {
  const { className, onClick, currentSlide, offsetYPositonArrows = 50 } = props;
  return (
    <div className={currentSlide === 0 ? "d-none" : ""}>
      <svg
        width="32"
        height="32"
        viewBox="0 0 32 32"
